...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createProjectDetails = () => {
        ...
        const techCards = Object.entries(project.technologies).map(([tech, description]) => `
            <div class="tech-card">
                <div class="tech-icon"><img src="icons/${tech.toLowerCase().replace(/ /g, '-')}.png" alt="${tech}"></div>
                <div class="tech-info">
                    <h4>${tech}</h4>
                    <p>${description}</p>
                </div>
        ...
        const contrAccordion = project.contributions.map((contr, index) => `
        ...
        projectDetailsContainer.innerHTML = `
            ...
            <div class="technologies-accordion">
                <div class="accordion-header">
            ...
            <div class="contributions-accordion">
                ${contrAccordion}
            </div>
            <h3>Best Features</h3>
